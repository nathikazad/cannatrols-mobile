...
class AppConfig {
  // Use stub services for development and testing
  static bool useStubServices = true;
}
...
final cureDataServiceProvider = Provider<CureDataService>((ref) {
  ...
  final CureDataService service = AppConfig.useStubServices
      ? StubCureDataService()
      : MqttCureDataService();
...
class CureDataController {
  ...
  StubCureDataService? get stubService => 
      _service is StubCureDataService ? _service as StubCureDataService : null;
